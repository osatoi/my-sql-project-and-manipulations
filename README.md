 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "## Scenario \n",
    "\n",
    "Little Lemon, an imaginary restaurant. In the [database-Setup notebook](database%20Setup.ipynb), I have created a database and designed tables to keep records of their key data. \n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "## Scenario: \n",
    "\n",
    "Little lemon need to perform some tasks on daily basis, and they involve extracting data from one or more tables. The tasks include finding the guest with maximum spending, retrieving the bookings for no arrival, and displaying the order status to the guests. \n",
    "\n",
    "To keep consistency during the data retrieval process, Little Lemon is interested to implement the required tasks using stored procedures. I will help Little Lemon create stored procedures so that they can call them according to their requirements in their python-based application."
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "source": [
    ...
    "\n",
    "I will Create a stored procedure `TopSpender` that can retrieve the booking ID, guest’s full name, and the bill amount of the top spender at closing."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "## Task 18:\n",
    "\n",
    "Little Lemon need to retrieve all those bookings where the guests did not appear today. \n",
    "Let's implement this task using a stored procedure; Using `NoArrival` as a name for our stored procedure."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "Let's Create a stored procedure named `OrderStatus` for the above task and call to check if everything is working."
   ]
  },
  {
   "cell_type": "code",
